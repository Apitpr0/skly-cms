        ...
        <?php
            ...
            while ($info = mysqli_fetch_array($data)) { ?>
                    <tr>
                        ...
                        <td class="border px-4 py-2"><?php echo $info['is_blocked'] ? '<span class="bg-red-500 text-white px-2 rounded">Blocked</span>' : '<span class="bg-green-500 text-white px-2 rounded">Active</span>'; ?></td>
                        <td class="border px-4 py-2">
                            <form method="post" class="inline">
                                <input type="hidden" name="user_id" value="<?php echo $info['id']; ?>">
                                <button type="submit" name="update" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Unblock</button>
                            </form>
                        </td>
                    </tr>
        </tbody>
