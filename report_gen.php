...
$html .= '<h1 class="text-3xl font-bold leading-tight text-gray-900 mb-6">Appointment Report</h1>';
$html .= '<table class="table-auto w-full">';
$html .= '<thead>';
$html .= '<tr class="bg-gray-100">';
$html .= '<th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Appointment ID</th>';
$html .= '<th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Name</th>';
$html .= '<th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Date</th>';
$html .= '<th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Time</th>';
$html .= '<th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Reason</th>';
$html .= '</tr>';
$html .= '</thead>';
